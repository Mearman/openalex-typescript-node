...
export class AssociatedInstitution extends null<String, DehydratedInstitution> {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AssociatedInstitution.attributeTypeMap);
    }
}
