...
export class WorkSchemaOpenAccess {
    'anyRepositoryHasFulltext': any | null;
    'isOa': any | null;
    'oaStatus': any | null;
    'oaUrl': any | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "anyRepositoryHasFulltext",
            "baseName": "any_repository_has_fulltext",
            "type": "any"
        },
        {
            "name": "isOa",
    ...
    static getAttributeTypeMap() {
        return WorkSchemaOpenAccess.attributeTypeMap;
    }
}
