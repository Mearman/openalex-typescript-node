...
export enum NgramsApiApiKeys {
}

export class NgramsApi {
    ...
    public setApiKey(key: NgramsApiApiKeys, value: string) {
        (this.authentications as any)[NgramsApiApiKeys[key]].apiKey = value;
    }
